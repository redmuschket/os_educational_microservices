...
Создана DNS-зона `фамилия.ai-info.ru` в панели управления VK Cloud.
...
Добавлена A-запись, связывающая домен `фамилия.ai-info.ru` с IP-адресом VPS. TTL установлен в 300 секунд.
...
- **QUESTION SECTION**: запрос типа `A` для `фамилия.ai-info.ru`
...
3. **NS-серверы `ai-info.ru`**: получены NS-серверы для подзоны `фамилия.ai-info.ru`
...
Дефолтная страница Nginx успешно открывается по доменному имени `фамилия.ai-info.ru` в веб-браузере.
